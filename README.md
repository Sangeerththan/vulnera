# Dependency Scanner [![Java CI with Maven](https://github.com/Sangeerththan/vulnera/actions/workflows/maven.yml/badge.svg?event=push)](https://github.com/Sangeerththan/vulnera/actions/workflows/maven.yml)
